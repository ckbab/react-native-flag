...
const SvgFk = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="FK_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="FK_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#07319C" />
        <Stop offset="100%" stopColor="#00247E" />
      </LinearGradient>
      <LinearGradient id="FK_svg__d" x1="50%" x2="50%" y1="0%" y2="100%">
      ...
      <Path
        ...
        id="FK_svg__c"
      />
      <LinearGradient id="FK_svg__e" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="FK_svg__g" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#187536" />
        <Stop offset="100%" stopColor="#0E5023" />
      </LinearGradient>
      <LinearGradient id="FK_svg__h" x1="50%" x2="50%" y1="0%" y2="100%">
    ...
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#FK_svg__a)" />
      <Path d="M0 0h21v15H0z" fill="url(#FK_svg__b)" />
      <G transform="translate(13 4)">
        <Mask fill="#fff" id="FK_svg__f">
      ...
      <Path
        ...
        fill="url(#FK_svg__a)"
      />
      <Path d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" fill="url(#FK_svg__h)" />
    </G>
  </Svg>
);
