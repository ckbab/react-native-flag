...
const SvgKi = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="KI_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="KI_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#E62B3F" />
        <Stop offset="100%" stopColor="#CA1A2C" />
      </LinearGradient>
      <LinearGradient id="KI_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFDA57" />
        <Stop offset="100%" stopColor="#FCD036" />
      </LinearGradient>
      <LinearGradient id="KI_svg__d" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#0752A2" />
        <Stop offset="100%" stopColor="#034285" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#KI_svg__a)" />
      <Path d="M0 0h21v8H0z" fill="url(#KI_svg__b)" />
      <Circle cx={10.5} cy={8.5} fill="url(#KI_svg__c)" r={2.5} />
      <Path
        ...
        fill="url(#KI_svg__c)"
      />
      <Path d="M0 8h21v7H0z" fill="url(#KI_svg__d)" />
      <Path
