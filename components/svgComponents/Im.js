...
const SvgIm = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="IM_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="IM_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#E52D42" />
        <Stop offset="100%" stopColor="#CB1D31" />
      </LinearGradient>
      <LinearGradient id="IM_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#F8DD4E" />
        <Stop offset="100%" stopColor="#F9DA38" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#IM_svg__a)" />
      <Path d="M0 0h21v15H0z" fill="url(#IM_svg__b)" />
      <Path
