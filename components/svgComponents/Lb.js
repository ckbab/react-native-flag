...
const SvgLb = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="LB_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="LB_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#F03340" />
        <Stop offset="100%" stopColor="#EB212E" />
      </LinearGradient>
      <LinearGradient id="LB_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#1FC065" />
        <Stop offset="100%" stopColor="#17A555" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#LB_svg__a)" />
      <Path d="M0 0h21v4H0zM0 11h21v4H0z" fill="url(#LB_svg__b)" />
      <Path d="M0 4h21v7H0z" fill="url(#LB_svg__a)" />
      <Path
