...
const SvgGbWls = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="GB-WLS_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="GB-WLS_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#3ACC55" />
        <Stop offset="100%" stopColor="#28A940" />
      </LinearGradient>
      <LinearGradient id="GB-WLS_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#E91C44" />
        <Stop offset="100%" stopColor="#D20F35" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#GB-WLS_svg__a)" />
      <Path d="M0 7h21v8H0z" fill="url(#GB-WLS_svg__b)" />
      <Path d="M0 0h21v7H0z" fill="url(#GB-WLS_svg__a)" />
      <Path
