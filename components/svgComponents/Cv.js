...
const SvgCv = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="CV_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="CV_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#0C49AE" />
        <Stop offset="100%" stopColor="#063B91" />
      </LinearGradient>
      <LinearGradient id="CV_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#CD232E" />
        <Stop offset="100%" stopColor="#CD232E" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#CV_svg__a)" />
      <Path d="M0 0h21v8H0zM0 11h21v4H0z" fill="url(#CV_svg__b)" />
      <Path d="M0 8h21v3H0z" fill="url(#CV_svg__a)" />
      <Path d="M0 9h21v1H0z" fill="url(#CV_svg__c)" />
      <Path
