...
const SvgBl = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="BL_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="BL_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
      ...
      <Path
        ...
        id="BL_svg__b"
      />
      <LinearGradient id="BL_svg__d" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#F7E14B" />
        <Stop offset="100%" stopColor="#F7DF3E" />
      </LinearGradient>
      <LinearGradient id="BL_svg__f" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#E12539" />
        <Stop offset="100%" stopColor="#CA192C" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#BL_svg__a)" />
      <G transform="translate(6.5 5)">
        <Mask fill="#fff" id="BL_svg__e">
        ...
        <Path
          ...
          mask="url(#BL_svg__e)"
        />
        <Path d="M.5 3h7v2h-7z" fill="url(#BL_svg__f)" mask="url(#BL_svg__e)" />
        <Circle cx={4} cy={4} fill="#FFF" mask="url(#BL_svg__e)" r={1} />
      </G>
      <Path
