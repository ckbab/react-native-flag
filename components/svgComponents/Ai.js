  ...
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      ...
      <LinearGradient id="linearGradient-2" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#0A17A7"></Stop>
        <Stop offset="100%" stopColor="#030E88"></Stop>
      </LinearGradient>
      <LinearGradient id="linearGradient_3" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#DB1E36"></Stop>
        <Stop offset="100%" stopColor="#D51931"></Stop>
      </LinearGradient>
      <Path
      ...
      <LinearGradient id="linearGradient-7" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFA51B"></Stop>
        <Stop offset="100%" stopColor="#FF9A00"></Stop>
      </LinearGradient>
    </Defs>
    <G
      fill="none"
