...
const SvgHr = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="HR_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="HR_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FF202D" />
        <Stop offset="100%" stopColor="#FD0D1B" />
      </LinearGradient>
      <LinearGradient id="HR_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#2027AC" />
        <Stop offset="100%" stopColor="#191F94" />
      </LinearGradient>
      <LinearGradient id="HR_svg__d" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FF212E" />
        <Stop offset="100%" stopColor="#FD0D1B" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#HR_svg__a)" />
      <Path d="M0 0h21v5H0z" fill="url(#HR_svg__b)" />
      <Path
      ...
      <Path
        ...
        opacity={0.5}
      />
      <Path d="M0 10h21v5H0z" fill="url(#HR_svg__c)" />
      <Path
