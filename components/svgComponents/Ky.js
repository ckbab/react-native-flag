...
const SvgKy = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="KY_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="KY_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#07319C" />
        <Stop offset="100%" stopColor="#00247E" />
      </LinearGradient>
      <LinearGradient id="KY_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
      ...
      <LinearGradient id="KY_svg__f" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#125FBA" />
        <Stop offset="100%" stopColor="#0C50A1" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#KY_svg__a)" />
      <Path d="M0 0h21v15H0z" fill="url(#KY_svg__b)" />
      <Path
      ...
      <Path
        ...
        fill="url(#KY_svg__a)"
      />
      <Path d="M0 3h4V0h1v3h4v1H5v3H4V4H0z" fill="url(#KY_svg__c)" />
      <Ellipse cx={15.5} cy={4} fill="#FAD051" rx={1.5} ry={1} />
      <G transform="translate(13 4)">
        <Mask fill="#fff" id="KY_svg__e">
          <Use xlinkHref="#KY_svg__d" />
        </Mask>
        <Use fill="url(#KY_svg__a)" xlinkHref="#KY_svg__d" />
        <Path d="M0 0h5v1H0z" fill="#CF142C" mask="url(#KY_svg__e)" />
        <Path
