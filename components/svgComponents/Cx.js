...
const SvgCx = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="CX_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="CX_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#0637C5" />
        <Stop offset="100%" stopColor="#002CAA" />
      </LinearGradient>
      <LinearGradient id="CX_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#3BA758" />
        <Stop offset="100%" stopColor="#2C8945" />
      </LinearGradient>
      <LinearGradient id="CX_svg__d" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFCC5D" />
        <Stop offset="100%" stopColor="#FEC54A" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#CX_svg__a)" />
      <Path d="M0 0h21v15H0z" fill="url(#CX_svg__b)" />
      <Path
