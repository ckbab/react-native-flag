...
const SvgMe = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="ME_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="ME_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#E6BE53" />
        <Stop offset="100%" stopColor="#D3AD46" />
      </LinearGradient>
      <LinearGradient id="ME_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#E01826" />
        <Stop offset="100%" stopColor="#C30A17" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#ME_svg__a)" />
      <Path d="M0 0h21v15H0z" fill="url(#ME_svg__b)" />
      <Rect
        fill="url(#ME_svg__c)"
        height={13}
        rx={0.75}
