...
const SvgKz = (props) => (
  <Svg height={15} viewBox="0 0 21 15" width={21} {...props}>
    <Defs>
      <LinearGradient id="KZ_svg__a" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFF" />
        <Stop offset="100%" stopColor="#F0F0F0" />
      </LinearGradient>
      <LinearGradient id="KZ_svg__b" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#30C6E0" />
        <Stop offset="100%" stopColor="#1CB0C9" />
      </LinearGradient>
      <LinearGradient id="KZ_svg__c" x1="50%" x2="50%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor="#FFCD4B" />
        <Stop offset="100%" stopColor="#FEC531" />
      </LinearGradient>
    </Defs>
    <G fill="none" fillRule="evenodd">
      <Path d="M0 0h21v15H0z" fill="url(#KZ_svg__a)" />
      <Path d="M0 0h21v15H0z" fill="url(#KZ_svg__b)" />
      <Circle cx={10.5} cy={7.5} fill="url(#KZ_svg__c)" r={3} />
      <Path
